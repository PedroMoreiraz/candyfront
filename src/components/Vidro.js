                ...
                <ul>
                    <div className={styles.shelf1}>
                        ...
                        <div className={styles.doces}>
                            {/* <li id='candyA'><img src={FiniMinhoca} alt='Fini minhoca' width={100} height={100}/></li> */}
                        </div>
                    </div>
                    <div className={styles.shelf2}>
                        <p className={styles.doceB}>B</p>
                        <div className={styles.doces}>
                            {/* <li id='candyB'><img src={FiniMinhoca} alt='Fini minhoca' width={100} height={100}/></li> */}
                        </div>
                    </div>
                    <div className={styles.shelf3}>
                        <p className={styles.doceC}>C</p>
                        <div className={styles.doces}>
                            {/* <li id='candyC'><img src={FiniMinhoca} alt='Fini minhoca' width={100} height={100}/></li> */}
                        </div>
                    </div>
                </ul>
            </div>
